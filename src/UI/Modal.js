    ...
    return (
        <div className='modal-container'>
            <form action="">
                ...
                <input type="text" placeholder='Enter Count' onChange={(e) => setCount(e.target.value)}/>
                </div>
                <div className="item">
                <label htmlFor="weight">Weight</label>
                <input type="text" placeholder='Enter Weight' onChange={(e) => setWeight(e.target.value)}/>
                </div>
                <div className="item">
